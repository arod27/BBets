...
```{r}
days=1:365
count=1135 # number of times the bet was made
repeatn=1000
varstor=numeric()
for (j in 1:repeatn) {
brownlow = 0
...
By using resampling I found that the average amount made was about $505.
...
I tried payouts of -3, -10, and I found eventually that a payoff of -4.40 was the 'fair' amount.


I found that if the class size = 28, Brownlow about breaks even. If the class size = 35 he makes money, if the class size = 15 he loses money. 
